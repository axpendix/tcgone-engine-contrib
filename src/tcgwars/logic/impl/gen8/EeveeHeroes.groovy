...
public enum EeveeHeroes implements LogicCardInfo {
  ...
  LEAFEON_VMAX_3 ("Leafeon VMAX", "3", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  ...
  GLACEON_VMAX_25 ("Glaceon VMAX", "25", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  ...
  SYLVEON_VMAX_41 ("Sylveon VMAX", "41", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _PSYCHIC_]),
  ...
  UMBREON_VMAX_48 ("Umbreon VMAX", "48", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _DARKNESS_]),
  ...
  LEAFEON_VMAX_88 ("Leafeon VMAX", "88", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  LEAFEON_VMAX_89 ("Leafeon VMAX", "89", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  GLACEON_VMAX_90 ("Glaceon VMAX", "90", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  GLACEON_VMAX_91 ("Glaceon VMAX", "91", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  SYLVEON_VMAX_92 ("Sylveon VMAX", "92", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _PSYCHIC_]),
  SYLVEON_VMAX_93 ("Sylveon VMAX", "93", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _PSYCHIC_]),
  UMBREON_VMAX_94 ("Umbreon VMAX", "94", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _DARKNESS_]),
  UMBREON_VMAX_95 ("Umbreon VMAX", "95", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _DARKNESS_]),
        ...
        bwAbility "Vise Coach", {
          ...
          delayedA {
            before APPLY_RESISTANCE, {
              if (ef.attacker.owner == self.owner && ef.attacker.singleStrike) {
                bc text
                prevent()
              }
            }
