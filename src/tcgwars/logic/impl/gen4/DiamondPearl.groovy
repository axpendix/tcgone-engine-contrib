...
public enum DiamondPearl implements LogicCardInfo {
  ...
  EMPOLEON_LV_X_120 ("Empoleon", 120, Rarity.HOLORARE, [LEVEL_UP, EVOLUTION, POKEMON, _WATER_]),
  INFERNAPE_LV_X_121 ("Infernape", 121, Rarity.HOLORARE, [LEVEL_UP, EVOLUTION, POKEMON, _FIRE_]),
  TORTERRA_LV_X_122 ("Torterra", 122, Rarity.HOLORARE, [LEVEL_UP, EVOLUTION, POKEMON, _GRASS_]),
