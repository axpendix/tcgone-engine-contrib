...
public enum ShinyVault implements LogicCardInfo {
  ...
  PHEROMOSA_SV5 ("Pheromosa", "SV5", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _GRASS_]),
  ...
  XURKITREE_SV14 ("Xurkitree", "SV14", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _LIGHTNING_]),
  ...
  POIPOLE_SV19 ("Poipole", "SV19", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _PSYCHIC_]),
  ...
  BUZZWOLE_SV24 ("Buzzwole", "SV24", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _FIGHTING_]),
  ZORUA_SV25 ("Zorua", "SV25", Rarity.HOLORARE, [POKEMON, BASIC, _DARKNESS_]),
  GUZZLORD_SV26 ("Guzzlord", "SV26", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _DARKNESS_]),
  ...
  CELESTEELA_SV32 ("Celesteela", "SV32", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _METAL_]),
  KARTANA_SV33 ("Kartana", "SV33", Rarity.HOLORARE, [POKEMON, BASIC, ULTRA_BEAST, _METAL_]),
  ...
  LEAFEON_GX_SV46 ("Leafeon-GX", "SV46", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _GRASS_]),
  DECIDUEYE_GX_SV47 ("Decidueye-GX", "SV47", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _GRASS_]),
  GOLISOPOD_GX_SV48 ("Golisopod-GX", "SV48", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _GRASS_]),
  CHARIZARD_GX_SV49 ("Charizard-GX", "SV49", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _FIRE_]),
  ...
  ALOLAN_NINETALES_GX_SV53 ("Alolan Ninetales-GX", "SV53", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _WATER_]),
  ARTICUNO_GX_SV54 ("Articuno-GX", "SV54", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, _WATER_]),
  GLACEON_GX_SV55 ("Glaceon-GX", "SV55", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _WATER_]),
  GRENINJA_GX_SV56 ("Greninja-GX", "SV56", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _WATER_]),
  ELECTRODE_GX_SV57 ("Electrode-GX", "SV57", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _LIGHTNING_]),
  XURKITREE_GX_SV58 ("Xurkitree-GX", "SV58", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _LIGHTNING_]),
  MEWTWO_GX_SV59 ("Mewtwo-GX", "SV59", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, _PSYCHIC_]),
  ESPEON_GX_SV60 ("Espeon-GX", "SV60", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _PSYCHIC_]),
  BANETTE_GX_SV61 ("Banette-GX", "SV61", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _PSYCHIC_]),
  NIHILEGO_GX_SV62 ("Nihilego-GX", "SV62", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _PSYCHIC_]),
  NAGANADEL_GX_SV63 ("Naganadel-GX", "SV63", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, ULTRA_BEAST, _PSYCHIC_]),
  LUCARIO_GX_SV64 ("Lucario-GX", "SV64", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIGHTING_]),
  ZYGARDE_GX_SV65 ("Zygarde-GX", "SV65", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, _FIGHTING_]),
  LYCANROC_GX_SV66 ("Lycanroc-GX", "SV66", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIGHTING_]),
  LYCANROC_GX_SV67 ("Lycanroc-GX", "SV67", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIGHTING_]),
  BUZZWOLE_GX_SV68 ("Buzzwole-GX", "SV68", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _FIGHTING_]),
  UMBREON_GX_SV69 ("Umbreon-GX", "SV69", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _DARKNESS_]),
  DARKRAI_GX_SV70 ("Darkrai-GX", "SV70", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, _DARKNESS_]),
  GUZZLORD_GX_SV71 ("Guzzlord-GX", "SV71", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _DARKNESS_]),
  SCIZOR_GX_SV72 ("Scizor-GX", "SV72", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _METAL_]),
  KARTANA_GX_SV73 ("Kartana-GX", "SV73", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _METAL_]),
  STAKATAKA_GX_SV74 ("Stakataka-GX", "SV74", Rarity.ULTRARARE, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _METAL_]),
  GARDEVOIR_GX_SV75 ("Gardevoir-GX", "SV75", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _FAIRY_]),
  SYLVEON_GX_SV76 ("Sylveon-GX", "SV76", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FAIRY_]),
  ALTARIA_GX_SV77 ("Altaria-GX", "SV77", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _DRAGON_]),
  NOIVERN_GX_SV78 ("Noivern-GX", "SV78", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _DRAGON_]),
  SILVALLY_GX_SV79 ("Silvally-GX", "SV79", Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _COLORLESS_]),
