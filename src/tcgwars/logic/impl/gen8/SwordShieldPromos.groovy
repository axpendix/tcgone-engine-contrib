...
public enum SwordShieldPromos implements LogicCardInfo {
  ...
  EEVEE_VMAX_SWSH87 ("Eevee VMAX", "SWSH087", Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_VMAX, NOT_IMPLEMENTED, _COLORLESS_]),
  ...
  DRAGAPULT_VMAX_SWSH97 ("Dragapult VMAX", "SWSH097", Rarity.PROMO, [POKEMON, EVOLUTION, VMAX, _PSYCHIC_]),
  CROBAT_V_SWSH98 ("Crobat V", "SWSH098", Rarity.PROMO, [POKEMON, POKEMON_V, BASIC, _DARKNESS_]),
  CROBAT_VMAX_SWSH99 ("Crobat VMAX", "SWSH099", Rarity.PROMO, [POKEMON, EVOLUTION, VMAX, _DARKNESS_]),
  ...
  VENUSAUR_VMAX_SWSH102 ("Venusaur VMAX", "SWSH102", Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_VMAX, _GRASS_]),
  BLASTOISE_VMAX_SWSH103 ("Venusaur VMAX", "SWSH103", Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_VMAX, _WATER_]),
