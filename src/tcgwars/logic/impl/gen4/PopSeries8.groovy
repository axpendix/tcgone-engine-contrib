...
public enum PopSeries8 implements LogicCardInfo {
  ...
  NIGHT_MAINTENANCE_9 ("Night Maintenance", "9", Rarity.UNCOMMON, [TRAINER, ITEM]),
  RARE_CANDY_10 ("Rare Candy", "10", Rarity.UNCOMMON, [TRAINER, ITEM]),
  ROSEANNE_S_RESEARCH_11 ("Roseanne's Research", "11", Rarity.UNCOMMON, [TRAINER, SUPPORTER]),
