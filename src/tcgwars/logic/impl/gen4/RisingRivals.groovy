...
public enum RisingRivals implements LogicCardInfo {
  ...
  ALAKAZAM_E4_LV_X_103 ("Alakazam E4", "103", Rarity.HOLORARE, [LVL_X, POKEMON, _PSYCHIC_]),
  FLOATZEL_GL_LV_X_104 ("Floatzel GL", "104", Rarity.HOLORARE, [LVL_X, POKEMON, _WATER_]),
  FLYGON_LV_X_105 ("Flygon", "105", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_]),
  GALLADE_E4_LV_X_106 ("Gallade E4", "106", Rarity.HOLORARE, [LVL_X, POKEMON, _PSYCHIC_]),
  HIPPOWDON_LV_X_107 ("Hippowdon", "107", Rarity.HOLORARE, [LVL_X, POKEMON, _FIGHTING_]),
  INFERNAPE_E4_LV_X_108 ("Infernape E4", "108", Rarity.HOLORARE, [LVL_X, POKEMON, _FIRE_]),
  LUXRAY_GL_LV_X_109 ("Luxray GL", "109", Rarity.HOLORARE, [LVL_X, POKEMON, _LIGHTNING_]),
  MISMAGIUS_GL_LV_X_110 ("Mismagius GL", "110", Rarity.HOLORARE, [LVL_X, POKEMON, _PSYCHIC_]),
  SNORLAX_LV_X_111 ("Snorlax", "111", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_]),
