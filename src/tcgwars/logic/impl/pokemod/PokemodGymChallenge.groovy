...
public enum PokemodGymChallenge implements LogicCardInfo {
  ...
  GIOVANNI_S_NIDORAN_FEMALE_75 ("Giovanni's Nidoran♀", "75", Rarity.COMMON, [BASIC, POKEMON, OWNERS_POKEMON, _GRASS_]),
  GIOVANNI_S_NIDORAN_MALE_76 ("Giovanni's Nidoran♂", "76", Rarity.COMMON, [BASIC, POKEMON, OWNERS_POKEMON, _GRASS_]),
