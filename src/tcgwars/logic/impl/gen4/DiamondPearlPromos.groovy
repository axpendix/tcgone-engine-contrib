...
public enum DiamondPearlPromos implements LogicCardInfo {
  ...
  ARCEUS_DP50 ("Arceus", "DP50", Rarity.PROMO, [BASIC, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ...
  ARCEUS_LV_X_DP53 ("Arceus Lv.X", "DP53", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ...
  ARCEUS_LV_X_DP56 ("Arceus Lv.X", "DP56", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
