...
public enum GreatEncounters implements LogicCardInfo {
  ...
  CRESSELIA_LV_X_103 ("Cresselia", "103", Rarity.ULTRARARE, [LEVEL_UP, POKEMON, _PSYCHIC_]),
  DARKRAI_LV_X_104 ("Darkrai", "104", Rarity.ULTRARARE, [LEVEL_UP, POKEMON, _DARKNESS_]),
  DIALGA_LV_X_105 ("Dialga", "105", Rarity.HOLORARE, [LEVEL_UP, POKEMON, _METAL_]),
  PALKIA_LV_X_106 ("Palkia", "106", Rarity.HOLORARE, [LEVEL_UP, POKEMON, _WATER_]);
