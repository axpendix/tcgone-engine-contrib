...
public enum RebelClash implements LogicCardInfo {
  ...
  LOMBRE_8 ("Lombre", 8, Rarity.HOLORARE, [POKEMON, EVOLUTION, STAGE1, _GRASS_, NOT_IMPLEMENTED]),
  ...
  LAMPENT_32 ("Lampent", 32, Rarity.HOLORARE, [POKEMON, EVOLUTION, STAGE1, _FIRE_, NOT_IMPLEMENTED]),
  ...
  LUXIO_61 ("Luxio", 61, Rarity.HOLORARE, [POKEMON, EVOLUTION, STAGE1, _LIGHTNING_, NOT_IMPLEMENTED]),
    ...
    switch (this) {
      ...
      return itemCard (this) {
        ...
        onPlay {
          ...
          tar.cards.getExcludedList(tar.cards.filterbyType(POKEMON)).discard()
