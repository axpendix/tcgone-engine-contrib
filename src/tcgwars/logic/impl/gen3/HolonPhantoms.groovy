...
public enum HolonPhantoms implements LogicCardInfo {
  ...
  HOLON_S_CASTFORM_44 ("Holon's Castform", "44", Rarity.UNCOMMON, [POKEMON, BASIC, OWNERS_POKEMON, _COLORLESS_]),
  ...
  GYARADOS_STAR_DELTA_102 ("Gyarados Star", "102", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, DELTA, _FIRE_]),
  MEWTWO_STAR_103 ("Mewtwo Star", "103", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _PSYCHIC_]),
  PIKACHU_STAR_104 ("Pikachu Star", "104", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _LIGHTNING_]),
