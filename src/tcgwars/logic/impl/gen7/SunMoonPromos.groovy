...
public enum SunMoonPromos implements LogicCardInfo {
  ...
  ROWLET_SM01 ("Rowlet", 1, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  LITTEN_SM02 ("Litten", 2, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  POPPLIO_SM03 ("Popplio", 3, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  PIKACHU_SM04 ("Pikachu", 4, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  SNORLAX_GX_SM05 ("Snorlax-GX", 5, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  ROCKRUFF_SM06 ("Rockruff", 6, Rarity.PROMO, [POKEMON, BASIC, _FIGHTING_]),
  PIKIPEK_SM07 ("Pikipek", 7, Rarity.PROMO, [POKEMON, BASIC, _COLORLESS_]),
  LITTEN_SM08 ("Litten", 8, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  TOGEDEMARU_SM09 ("Togedemaru", 9, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  SHIINOTIC_SM10 ("Shiinotic", 10, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  ...
  ALOLAN_SANDSLASH_SM18 ("Alolan Sandslash", 18, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _WATER_]),
  ORICORIO_SM19 ("Oricorio", 19, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  MUDSDALE_SM20 ("Mudsdale", 20, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  DRAMPA_SM21 ("Drampa", 21, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  ROWLET_SM22 ("Rowlet", 22, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  LITTEN_SM23 ("Litten", 23, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  POPPLIO_SM24 ("Popplio", 24, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  LURANTIS_SM25 ("Lurantis", 25, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  TSAREENA_SM26 ("Tsareena", 26, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _GRASS_]),
  TURTONATOR_SM27 ("Turtonator", 27, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  VIKAVOLT_SM28 ("Vikavolt", 28, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _LIGHTNING_]),
  MIMIKYU_SM29 ("Mimikyu", 29, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  TAPU_KOKO_SM30 ("Tapu Koko", 30, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  TAPU_KOKO_SM31 ("Tapu Koko", 31, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  TAPU_BULU_GX_SM32 ("Tapu Bulu-GX", 32, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _GRASS_]),
  TAPU_KOKO_GX_SM33 ("Tapu Koko-GX", 33, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  BEWEAR_GX_SM34 ("Bewear-GX", 34, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _COLORLESS_]),
  ESPEON_GX_SM35 ("Espeon-GX", 35, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _PSYCHIC_]),
  UMBREON_GX_SM36 ("Umbreon-GX", 36, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _DARKNESS_]),
  DECIDUEYE_GX_SM37 ("Decidueye-GX", 37, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _GRASS_]),
  INCINEROAR_GX_SM38 ("Incineroar-GX", 38, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _FIRE_]),
  PRIMARINA_GX_SM39 ("Primarina-GX", 39, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _WATER_]),
  JANGMO_O_SM40 ("Jangmo-o", 40, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  KOMALA_SM41 ("Komala", 41, Rarity.PROMO, [POKEMON, BASIC, _COLORLESS_]),
  COSMOG_SM42 ("Cosmog", 42, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  ALOLAN_MEOWTH_SM43 ("Alolan Meowth", 43, Rarity.PROMO, [POKEMON, BASIC, _DARKNESS_]),
  TOGEDEMARU_SM44 ("Togedemaru", 44, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  TAPU_LELE_SM45 ("Tapu Lele", 45, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  SEVIPER_SM46 ("Seviper", 46, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  CRABOMINABLE_SM47 ("Crabominable", 47, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  ZYGARDE_SM48 ("Zygarde", 48, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  BEWEAR_SM49 ("Bewear", 49, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _COLORLESS_]),
  TAPU_KOKO_GX_SM50 ("Tapu Koko-GX", 50, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  ALOLAN_MEOWTH_SM51 ("Alolan Meowth", 51, Rarity.PROMO, [POKEMON, BASIC, _DARKNESS_]),
  GOLISOPOD_SM52 ("Golisopod", 52, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  DHELMISE_SM53 ("Dhelmise", 53, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  LUCARIO_SM54 ("Lucario", 54, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  DECIDUEYE_SM55 ("Decidueye", 55, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _GRASS_]),
  TSAREENA_GX_SM56 ("Tsareena-GX", 56, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _GRASS_]),
  HO_OH_GX_SM57 ("Ho-Oh-GX", 57, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _FIRE_]),
  NECROZMA_GX_SM58 ("Necrozma-GX", 58, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _PSYCHIC_]),
  MARSHADOW_GX_SM59 ("Marshadow-GX", 59, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _FIGHTING_]),
  CHARIZARD_GX_SM60 ("Charizard-GX", 60, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _FIRE_]),
  TAPU_BULU_SM61 ("Tapu Bulu", 61, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  GOLISOPOD_GX_SM62 ("Golisopod-GX", 62, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _GRASS_]),
  SALAZZLE_GX_SM63 ("Salazzle-GX", 63, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIRE_]),
  SILVALLY_SM64 ("Silvally", 64, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _COLORLESS_]),
  ALOLAN_RAICHU_SM65 ("Alolan Raichu", 65, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _LIGHTNING_]),
  PHEROMOSA_GX_SM66 ("Pheromosa-GX", 66, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _GRASS_]),
  CELESTEELA_GX_SM67 ("Celesteela-GX", 67, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _METAL_]),
  ...
  REGISTEEL_SM75 ("Registeel", 75, Rarity.PROMO, [POKEMON, BASIC, _METAL_]),
  PIKACHU_SM76 ("Pikachu", 76, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  MEWTWO_SM77 ("Mewtwo", 77, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  CHAMPIONS_FESTIVAL_SM78 ("Champions Festival", 78, Rarity.PROMO, [TRAINER, STADIUM]),
  SHINING_CELEBI_SM79 ("Shining Celebi", 79, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  HO_OH_GX_SM80 ("Ho-Oh-GX", 80, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _FIRE_]),
  PIKACHU_SM81 ("Pikachu", 81, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  SHINING_LUGIA_SM82 ("Shining Lugia", 82, Rarity.PROMO, [POKEMON, BASIC, _COLORLESS_]),
  ZORUA_SM83 ("Zorua", 83, Rarity.PROMO, [POKEMON, BASIC, _DARKNESS_]),
  ZOROARK_GX_SM84 ("Zoroark-GX", 84, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _DARKNESS_]),
  MARSHADOW_SM85 ("Marshadow", 85, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  PIKACHU_SM86 ("Pikachu", 86, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  LATIAS_SM87 ("Latias", 87, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  LATIOS_SM88 ("Latios", 88, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  ZOROARK_SM89 ("Zoroark", 89, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _DARKNESS_]),
  RAICHU_GX_SM90 ("Raichu-GX", 90, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _LIGHTNING_]),
  SILVALLY_GX_SM91 ("Silvally-GX", 91, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _COLORLESS_]),
  TAPU_FINI_SM92 ("Tapu Fini", 92, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  MARSHADOW_SM93 ("Marshadow", 93, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  WASH_ROTOM_SM94 ("Wash Rotom", 94, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  LUCARIO_SM95 ("Lucario", 95, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  HEATRAN_SM96 ("Heatran", 96, Rarity.PROMO, [POKEMON, BASIC, _METAL_]),
  GUMSHOOS_SM97 ("Gumshoos", 97, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _COLORLESS_]),
  PIKACHU_SM98 ("Pikachu", 98, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  MIMIKYU_SM99 ("Mimikyu", 99, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  LUCARIO_GX_SM100 ("Lucario-GX", 100, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIGHTING_]),
  DAWN_WINGS_NECROZMA_GX_SM101 ("Dawn Wings Necrozma-GX", 101, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _PSYCHIC_]),
  DUSK_MANE_NECROZMA_GX_SM102 ("Dusk Mane Necrozma-GX", 102, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _METAL_]),
  LUNALA_GX_SM103 ("Lunala-GX", 103, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _PSYCHIC_]),
  SOLGALEO_GX_SM104 ("Solgaleo-GX", 104, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _METAL_]),
  LYCANROC_SM105 ("Lycanroc", 105, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  DAWN_WINGS_NECROZMA_SM106 ("Dawn Wings Necrozma", 106, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _PSYCHIC_]),
  DUSK_MANE_NECROZMA_SM107 ("Dusk Mane Necrozma", 107, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _METAL_]),
  ASH_S_PIKACHU_SM108 ("Ash's Pikachu", 108, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM109 ("Ash's Pikachu", 109, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM110 ("Ash's Pikachu", 110, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM111 ("Ash's Pikachu", 111, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM112 ("Ash's Pikachu", 112, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM113 ("Ash's Pikachu", 113, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ASH_S_PIKACHU_SM114 ("Ash's Pikachu", 114, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  PHEROMOSA_SM115 ("Pheromosa", 115, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _GRASS_]),
  XURKITREE_SM116 ("Xurkitree", 116, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _LIGHTNING_]),
  MALAMAR_SM117 ("Malamar", 117, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _PSYCHIC_]),
  LYCANROC_SM118 ("Lycanroc", 118, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIGHTING_]),
  EXEGGCUTE_SM119 ("Exeggcute", 119, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  ROCKRUFF_SM120 ("Rockruff", 120, Rarity.PROMO, [POKEMON, BASIC, _FIGHTING_]),
  RAIKOU_GX_SM121 ("Raikou-GX", 121, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  ZYGARDE_GX_SM122 ("Zygarde-GX", 122, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _FIGHTING_]),
  DAWN_WINGS_NECROZMA_SM123 ("Dawn Wings Necrozma", 123, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _PSYCHIC_]),
  DUSK_MANE_NECROZMA_SM124 ("Dusk Mane Necrozma", 124, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _METAL_]),
  NAGANADEL_GX_SM125 ("Naganadel-GX", 125, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, ULTRA_BEAST, _PSYCHIC_]),
  ULTRA_NECROZMA_GX_SM126 ("Ultra Necrozma GX", 126, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, ULTRA_BEAST, _DRAGON_]),
  ALOLAN_SANDSLASH_SM127 ("Alolan Sandslash", 127, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _METAL_]),
  ALOLAN_NINETALES_SM128 ("Alolan Ninetales", 128, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FAIRY_]),
  KYOGRE_SM129 ("Kyogre", 129, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  MANECTRIC_SM130 ("Manectric", 130, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _LIGHTNING_]),
  CELESTEELA_SM131 ("Celesteela", 131, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _METAL_]),
  DELCATTY_SM132 ("Delcatty", 132, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _COLORLESS_]),
  THUNDURUS_GX_SM133 ("Thundurus-GX", 133, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  TORNADUS_GX_SM134 ("Tornadus-GX", 134, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  LATIAS_SM135 ("Latias", 135, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  LATIOS_SM136 ("Latios", 136, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  RESHIRAM_GX_SM137 ("Reshiram-GX", 137, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _FIRE_]),
  ZEKROM_GX_SM138 ("Zekrom-GX", 138, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  SALAMENCE_GX_SM139 ("Salamence-GX", 139, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _DRAGON_]),
  SALAMENCE_SM140 ("Salamence", 140, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _DRAGON_]),
  WHITE_KYUREM_GX_SM141 ("White Kyurem-GX", 141, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _DRAGON_]),
  KYUREM_SM142 ("Kyurem", 142, Rarity.PROMO, [POKEMON, BASIC, _DRAGON_]),
  MOLTRES_SM143 ("Moltres", 143, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  ARTICUNO_SM144 ("Articuno", 144, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  ZAPDOS_SM146 ("Zapdos", 145, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  LEAFEON_GX_SM145 ("Leafeon-GX", 146, Rarity.PROMO, [STAGE1, EVOLUTION, POKEMON, POKEMON_GX, _GRASS_]),
  GLACEON_GX_SM147 ("Glaceon-GX", 147, Rarity.PROMO, [STAGE1, EVOLUTION, POKEMON, POKEMON_GX, _WATER_]),
  CHAMPIONS_FESTIVAL_SM148 ("Champions Festival", 148, Rarity.PROMO, [TRAINER, STADIUM]),
  SUICUNE_SM149 ("Suicune", 149, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  RAIKOU_SM150 ("Raikou", 150, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  GIRATINA_SM151 ("Giratina", 151, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  TAPU_LELE_SM152 ("Tapu Lele", 152, Rarity.PROMO, [POKEMON, BASIC, _FAIRY_]),
  ROWLET_SM153 ("Rowlet", 153, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  SALANDIT_SM154 ("Salandit", 154, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  KINGDRA_GX_SM155 ("Kingdra-GX", 155, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _WATER_]),
  DRAGONITE_GX_SM156 ("Dragonite-GX", 156, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _DRAGON_]),
  PIKACHU_SM157 ("Pikachu", 157, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  CHARIZARD_SM158 ("Charizard", 158, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _FIRE_]),
  ZAPDOS_SM159 ("Zapdos", 159, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  NIDOQUEEN_SM160 ("Nidoqueen", 160, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _PSYCHIC_]),
  JIRACHI_SM161 ("Jirachi", 161, Rarity.PROMO, [POKEMON, BASIC, _METAL_]),
  PIKACHU_SM162 ("Pikachu", 162, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  MIMIKYU_SM163 ("Mimikyu", 163, Rarity.PROMO, [POKEMON, BASIC, _FAIRY_]),
  DEOXYS_SM164 ("Deoxys", 164, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  ULTRA_NECROZMA_SM165 ("Ultra Necrozma", 165, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _DRAGON_]),
  MAGIKARP_WAILORD_GX_SM166 ("Magikarp & Wailord-GX", 166, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _WATER_]),
  CELEBI_VENUSAUR_GX_SM167 ("Celebi & Venusaur-GX", 167, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _GRASS_]),
  PIKACHU_ZEKROM_GX_SM168 ("Pikachu & Zekrom-GX", 168, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _LIGHTNING_]),
  EEVEE_SNORLAX_GX_SM169 ("Eevee & Snorlax-GX", 169, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _COLORLESS_]),
  DETECTIVE_PIKACHU_SM170 ("Detective Pikachu", 170, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  FLAREON_GX_SM171 ("Flareon-GX", 171, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIRE_]),
  VAPOREON_GX_SM172 ("Vaporeon-GX", 172, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _WATER_]),
  JOLTEON_GX_SM173 ("Jolteon-GX", 173, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _LIGHTNING_]),
  EEVEE_GX_SM174 ("Eevee-GX", 174, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  EEVEE_GX_SM175 ("Eevee-GX", 175, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  EEVEE_GX_SM176 ("Eevee-GX", 176, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  MELTAN_SM177 ("Meltan", 177, Rarity.PROMO, [POKEMON, BASIC, _METAL_]),
  MELMETAL_SM178 ("Melmetal-GX", 178, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _METAL_]),
  VOLCANION_SM179 ("Volcanion", 179, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  STAKATAKA_SM180 ("Stakataka", 180, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _FIGHTING_]),
  MELMETAL_SM181 ("Melmetal", 181, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _METAL_]),
  PERSIAN_SM182 ("Persian", 182, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _COLORLESS_]),
  PIKACHU_SM183 ("Pikachu", 183, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  EEVEE_SM184 ("Eevee", 184, Rarity.PROMO, [POKEMON, BASIC, _COLORLESS_]),
  TYPHLOSION_SM185 ("Typhlosion", 185, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _FIRE_]),
  FLAREON_SM186 ("Flareon", 186, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _FIRE_]),
  ALOLAN_MAROWAK_GX_SM187 ("Alolan Marowak-GX", 187, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _FIRE_]),
  KANGASKHAN_GX_SM188 ("Kangaskhan-GX", 188, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  BLASTOISE_GX_SM189 ("Blastoise-GX", 189, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, POKEMON_GX, _WATER_]),
  DETECTIVE_PIKACHU_SM190 ("Detective Pikachu", 190, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ...
  DETECTIVE_PIKACHU_SM194 ("Detective Pikachu", 194, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  CHARIZARD_GX_SM195 ("Charizard-GX", 195, Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_GX, STAGE2, _FIRE_]),
  MEWTWO_GX_SM196 ("Mewtwo-GX", 196, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _PSYCHIC_]),
  GRENINJA_GX_SM197 ("Greninja-GX", 197, Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_GX, STAGE2, _WATER_]),
  BULBASAUR_SM198 ("Bulbasaur", 198, Rarity.PROMO, [POKEMON, BASIC, _GRASS_]),
  PSYDUCK_SM199 ("Psyduck", 199, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  SNUBBULL_SM200 ("Snubbull", 200, Rarity.PROMO, [POKEMON, BASIC, _FAIRY_]),
  RESHIRAM_CHARIZARD_GX_SM201 ("Reshiram & Charizard-GX", 201, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _FIRE_]),
  AMOONGUSS_SM202 ("Amoonguss", 202, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  TAPU_FINI_SM203 ("Tapu Fini", 203, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  NECROZMA_SM204 ("Necrozma", 204, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  TERRAKION_SM205 ("Terrakion", 205, Rarity.PROMO, [POKEMON, BASIC, _FIGHTING_]),
  PIKACHU_SM206 ("Pikachu", 206, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  SUDOWOODO_SM207 ("Sudowoodo", 207, Rarity.PROMO, [POKEMON, BASIC, _FIGHTING_]),
  VIKAVOLT_SM208 ("Vikavolt", 208, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _LIGHTNING_]),
  STAKATAKA_SM209 ("Stakataka", 209, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _FIGHTING_]),
  ...
  PORYGON_Z_GX_SM216 ("Porygon-Z-GX", 216, Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_GX, STAGE2, _COLORLESS_]),
  TREVENANT_DUSKNOIR_GX_SM217 ("Trevenant & Dusknoir-GX", 217, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _PSYCHIC_]),
  BUZZWOLE_SM218 ("Buzzwole", 218, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _GRASS_]),
  ENTEI_SM219 ("Entei", 219, Rarity.PROMO, [POKEMON, BASIC, _FIRE_]),
  PHIONE_SM220 ("Phione", 220, Rarity.PROMO, [POKEMON, BASIC, _WATER_]),
  BLACEPHALON_SM221 ("Blacephalon", 221, Rarity.PROMO, [POKEMON, BASIC, ULTRA_BEAST, _PSYCHIC_]),
  MISMAGIUS_SM222 ("Mismagius", 222, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _PSYCHIC_]),
  TERRAKION_SM223 ("Terrakion", 223, Rarity.PROMO, [POKEMON, BASIC, _FIGHTING_]),
  CELEBI_SM224 ("Celebi", 224, Rarity.PROMO, [POKEMON, NOT_IMPLEMENTED, BASIC, _PSYCHIC_]),
  ...
  PIKACHU_SM227 ("Pikachu", 227, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  ARMORED_MEWTWO_SM228 ("Armored Mewtwo", 228, Rarity.PROMO, [POKEMON, BASIC, _PSYCHIC_]),
  VENUSAUR_SNIVY_GX_SM229 ("Venusaur & Snivy-GX", 229, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, TAG_TEAM, _GRASS_]),
  ...
  PIKACHU_GX_SM232 ("Pikachu-GX", 232, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _LIGHTNING_]),
  EEVEE_GX_SM233 ("Eevee-GX", 233, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _COLORLESS_]),
  PIKACHU_SM234 ("Pikachu", 234, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  EEVEE_SM235 ("Eevee", 235, Rarity.PROMO, [POKEMON, BASIC, _COLORLESS_]),
  ALOLAN_SANDSLASH_GX_SM236 ("Alolan Sandslash-GX", 236, Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_GX, STAGE1, _WATER_]),
  LEAFEON_SM237 ("Leafeon", 237, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  GLACEON_SM238 ("Glaceon", 238, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _WATER_]),
  CARRACOSTA_GX_SM239 ("Carracosta-GX", 239, Rarity.PROMO, [POKEMON, EVOLUTION, POKEMON_GX, STAGE2, _FIGHTING_]),
      ...
      case PORYGON_Z_GX_SM216:
        return evolution (this, from:"Porygon2", hp:HP240, type:C, retreatCost:2) {
          ...
          bwAbility "Troubleshooting", {
            ...
            actionA {
              checkLastTurn()
              assert self.findAll(cardTypeFilter(SPECIAL_ENERGY)) : "There are no special energies attached"
