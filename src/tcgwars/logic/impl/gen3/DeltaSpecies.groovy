...
public enum DeltaSpecies implements LogicCardInfo {
  ...
  HOLON_S_ELECTRODE_21 ("Holon's Electrode", "21", Rarity.RARE, [POKEMON, EVOLUTION, STAGE1, _LIGHTNING_, OWNERS_POKEMON]),
  HOLON_S_MAGNETON_22 ("Holon's Magneton", "22", Rarity.RARE, [POKEMON, EVOLUTION, STAGE1, _METAL_, OWNERS_POKEMON]),
  ...
  HOLON_S_MAGNEMITE_70 ("Holon's Magnemite", "70", Rarity.COMMON, [POKEMON, BASIC, _METAL_, OWNERS_POKEMON]),
  HOLON_S_VOLTORB_71 ("Holon's Voltorb", "71", Rarity.COMMON, [POKEMON, BASIC, _LIGHTNING_, OWNERS_POKEMON]),
  ...
  GROUDON_STAR_111 ("Groudon Star", "111", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _FIGHTING_]),
  KYOGRE_STAR_112 ("Kyogre Star", "112", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _WATER_]),
    ...
    switch (this) {
      ...
      return basic (this, hp:HP080, type:[L, M], retreatCost:2) {
        ...
        move "Psychic Force", {
          ...
          energyCost L, M, C, C, C
          onAttack {
            if (opp.all.any{ it.evolution && it.stage2 }) {
              damage 80
            }
          }
        }
        ...
        pokeBody "Delta Guard", {
          ...
          delayedA {
            before CHECK_ATTACK_REQUIREMENTS, {
              if (ef.attacker == self && self.cards.any{ it.name.contains("Holon Energy") } && ef.move.name == "Lightning Storm") {
      ...
      return evolution (this, from:"Eevee", hp:HP070, type:[D, M], retreatCost:1) {
        ...
        pokeBody "Delta Moon", {
          ...
          delayedA {
            after ATTACH_ENERGY, {
              if (ef.reason == PLAY_FROM_HAND && ef.card.cardTypes.is(SPECIAL_ENERGY) && e.targetPokemon.owner == self.owner.opposite && !e.context['Delta_Moon']) {
                directDamage 10, e.targetPokemon
                bc "Delta Moon activates"
                e.context['Delta_Moon'] = 1
              }
            }
          }
        }
      ...
      return itemCard (this) {
        ...
        onPlay {
          ...
          if (choice == 1) {
            ...
            if (tar) {
              tar.showToOpponent("Opponent played Holon Transceiver and searched their deck for this Holon Supporter.").moveTo(my.hand)
            }
            shuffleDeck()
          }
          else {
            my.discard.findAll{
              it.cardTypes.is(SUPPORTER) &&
              it.name.contains("Holon")
            }.select("Which card to move to hand?").showToOpponent("Opponent played Holon Transceiver and will move this Holon Supporter from their discard pile to their hand.").moveTo(my.hand)
          }
        }
        playRequirement {
      ...
      return specialEnergy (this, [[C]]) {
        ...
        onPlay { reason ->
          eff = getter(GET_WEAKNESSES) { h ->
            if (self != null && h.effect.target == self && !self.EX && self.cards.filterByType(BASIC_ENERGY).filterByEnergyType(R)) {
              h.object.clear()
            }
          }
          eff2 = delayed {
      ...
      return specialEnergy (this, [[C]]) {
        ...
        def eff
        def eff2
        def doOnInit = { PokemonCardSet pokemon ->
          if (pokemon != null && !pokemon.EX && pokemon.cards.filterByBasicEnergyType(G)) {
            clearSpecialCondition(pokemon)
          }
        }
        onPlay { reason ->
          doOnInit(self)
          eff = delayed {
            before APPLY_SPECIAL_CONDITION, {
              if (self != null && e.targetPokemon == self && !self.EX && self.cards.filterByBasicEnergyType(G)) {
                targeted self, {
            ...
            after ATTACH_ENERGY, {
              if (self != null && !self.EX && self.cards.filterByBasicEnergyType(G)) {
          ...
          eff2 = delayed {
            before APPLY_ATTACK_DAMAGES, {
              if (self != null && !self.EX && self.cards.filterByBasicEnergyType(L)) {
                targeted self, {
                  bg.dm().each {
      ...
      return specialEnergy (this, [[C]]) {
        ...
        def eff2
        onPlay { reason ->
          eff = getterA(GET_RETREAT_COST, BEFORE_LAST) { h ->
          ...
          eff2 = delayed {
            before null, null, Source.ATTACK, {
              if (e.targetPokemon == self && self != null && !self.EX && self.cards.filterByBasicEnergyType(W) && bg.currentTurn == self.owner.opposite && ef.effectType != DAMAGE && !(ef instanceof ApplyDamages)) {
                targeted self, {
