...
public enum Platinum implements LogicCardInfo {
  ...
  DIALGA_G_LV_X_122 ("Dialga G", "122", Rarity.HOLORARE, [LVL_X, POKEMON, _METAL_]),
  DRAPION_LV_X_123 ("Drapion", "123", Rarity.HOLORARE, [LVL_X, POKEMON, _DARKNESS_]),
  GIRATINA_LV_X_124 ("Giratina", "124", Rarity.HOLORARE, [LVL_X, POKEMON, _PSYCHIC_]),
  PALKIA_G_LV_X_125 ("Palkia G", "125", Rarity.HOLORARE, [LVL_X, POKEMON, _WATER_]),
  SHAYMIN_LV_X_126 ("Shaymin", "126", Rarity.HOLORARE, [LVL_X, POKEMON, _GRASS_]),
  SHAYMIN_LV_X_127 ("Shaymin", "127", Rarity.HOLORARE, [LVL_X, POKEMON, _GRASS_]),
