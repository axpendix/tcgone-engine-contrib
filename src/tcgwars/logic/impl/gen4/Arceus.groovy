...
public enum Arceus implements LogicCardInfo {
  ...
  ARCEUS_LV_X_94 ("Arceus Lv.X", "94", Rarity.HOLORARE, [LVL_X, POKEMON, UNLIMITED_COPIES, _COLORLESS_]),
  ARCEUS_LV_X_95 ("Arceus Lv.X", "95", Rarity.HOLORARE, [LVL_X, POKEMON, UNLIMITED_COPIES, _COLORLESS_]),
  ARCEUS_LV_X_96 ("Arceus Lv.X", "96", Rarity.HOLORARE, [LVL_X, POKEMON, UNLIMITED_COPIES, _COLORLESS_]),
  ...
  ARCEUS_AR1 ("Arceus", "AR1", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _DARKNESS_]),
  ARCEUS_AR2 ("Arceus", "AR2", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _GRASS_]),
  ARCEUS_AR3 ("Arceus", "AR3", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _FIRE_]),
  ARCEUS_AR4 ("Arceus", "AR4", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _WATER_]),
  ARCEUS_AR5 ("Arceus", "AR5", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _COLORLESS_]),
  ARCEUS_AR6 ("Arceus", "AR6", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _LIGHTNING_]),
  ARCEUS_AR7 ("Arceus", "AR7", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _PSYCHIC_]),
  ARCEUS_AR8 ("Arceus", "AR8", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _FIGHTING_]),
  ARCEUS_AR9 ("Arceus", "AR9", Rarity.HOLORARE, [BASIC, POKEMON, UNLIMITED_COPIES, _METAL_]);
