...
public enum SunMoonPromos implements LogicCardInfo {
  ...
  VOLCANION_SM179("Volcanion", 179, Rarity.PROMO, [POKEMON,_FIRE_,BASIC]),
  STAKATAKA_SM180("Stakataka", 180, Rarity.PROMO, [POKEMON,_FIGHTING_,BASIC,ULTRA_BEAST]),
  MELMETAL_SM181("Melmetal", 181, Rarity.PROMO, [POKEMON,_METAL_,STAGE1,EVOLUTION]),
  PERSIAN_SM182("Persian", 182, Rarity.PROMO, [POKEMON,_COLORLESS_,STAGE1,EVOLUTION]),
  PIKACHU_SM183("Pikachu", 183, Rarity.PROMO, [POKEMON,_LIGHTNING_,BASIC]),
  EEVEE_SM184("Eevee", 184, Rarity.PROMO, [POKEMON,_COLORLESS_,BASIC]),
            ...
            onAttack{
              ...
              delayed {
                before null, null, Source.ATTACK, {
                  if (bg.currentTurn==self.owner.opposite && (ef as TargetedEffect).getResolvedTarget(bg, e)==self) {
