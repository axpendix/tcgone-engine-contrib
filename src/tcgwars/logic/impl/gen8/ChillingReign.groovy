...
public enum ChillingReign implements LogicCardInfo {
  ...
  AGATHA_186 ("Agatha", "186", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  AVERY_187 ("Avery", "187", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  BRAWLY_188 ("Brawly", "188", Rarity.ULTRARARE, [TRAINER, SUPPORTER, RAPID_STRIKE]),
  CAITLIN_189 ("Caitlin", "189", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  DOCTOR_190 ("Doctor", "190", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  FLANNERY_191 ("Flannery", "191", Rarity.ULTRARARE, [TRAINER, SINGLE_STRIKE, SUPPORTER]),
  HONEY_192 ("Honey", "192", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  KAREN_S_CONVICTION_193 ("Karen's Conviction", "193", Rarity.ULTRARARE, [TRAINER, SINGLE_STRIKE, SUPPORTER]),
  KLARA_194 ("Klara", "194", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  MELONY_195 ("Melony", "195", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  PEONIA_196 ("Peonia", "196", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  PEONY_197 ("Peony", "197", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  SIEBOLD_198 ("Siebold", "198", Rarity.ULTRARARE, [TRAINER, SUPPORTER, RAPID_STRIKE]),
  CELEBI_VMAX_199 ("Celebi VMAX", "199", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  BLAZIKEN_VMAX_200 ("Blaziken VMAX", "200", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, RAPID_STRIKE, _FIRE_]),
  BLAZIKEN_VMAX_201 ("Blaziken VMAX", "201", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, RAPID_STRIKE, _FIRE_]),
  ICE_RIDER_CALYREX_VMAX_202 ("Ice Rider Calyrex VMAX", "202", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  ICE_RIDER_CALYREX_VMAX_203 ("Ice Rider Calyrex VMAX", "203", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  SHADOW_RIDER_CALYREX_VMAX_204 ("Shadow Rider Calyrex VMAX", "204", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _PSYCHIC_]),
  SHADOW_RIDER_CALYREX_VMAX_205 ("Shadow Rider Calyrex VMAX", "205", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _PSYCHIC_]),
  SANDACONDA_VMAX_206 ("Sandaconda VMAX", "206", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _FIGHTING_]),
  GALARIAN_SLOWKING_VMAX_207 ("Galarian Slowking VMAX", "207", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, SINGLE_STRIKE, _DARKNESS_]),
  METAGROSS_VMAX_208 ("Metagross VMAX", "208", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, RAPID_STRIKE, _METAL_]),
  TORNADUS_VMAX_209 ("Tornadus VMAX", "209", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, SINGLE_STRIKE, _COLORLESS_]),
  AGATHA_210 ("Agatha", "210", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  AVERY_211 ("Avery", "211", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  BRAWLY_212 ("Brawly", "212", Rarity.ULTRARARE, [TRAINER, SUPPORTER, RAPID_STRIKE]),
  CAITLIN_213 ("Caitlin", "213", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  DOCTOR_214 ("Doctor", "214", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  FLANNERY_215 ("Flannery", "215", Rarity.ULTRARARE, [TRAINER, SINGLE_STRIKE, SUPPORTER]),
  KAREN_S_CONVICTION_216 ("Karen's Conviction", "216", Rarity.ULTRARARE, [TRAINER, SINGLE_STRIKE, SUPPORTER]),
  KLARA_217 ("Klara", "217", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  MELONY_218 ("Melony", "218", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  PEONIA_219 ("Peonia", "219", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  PEONY_220 ("Peony", "220", Rarity.ULTRARARE, [TRAINER, SUPPORTER]),
  SIEBOLD_221 ("Siebold", "221", Rarity.ULTRARARE, [TRAINER, SUPPORTER, RAPID_STRIKE]),
  ELECTRODE_222 ("Electrode", "222", Rarity.SECRET, [POKEMON, EVOLUTION, STAGE1, _LIGHTNING_]),
  BRONZONG_223 ("Bronzong", "223", Rarity.SECRET, [POKEMON, EVOLUTION, STAGE1, _METAL_]),
  SNORLAX_224 ("Snorlax", "224", Rarity.SECRET, [POKEMON, BASIC, _COLORLESS_]),
  ECHOING_HORN_225 ("Echoing Horn", "225", Rarity.SECRET, [TRAINER, RAPID_STRIKE, ITEM]),
  FAN_OF_WAVES_226 ("Fan of Waves", "226", Rarity.SECRET, [TRAINER, RAPID_STRIKE, ITEM]),
  FOG_CRYSTAL_227 ("Fog Crystal", "227", Rarity.SECRET, [TRAINER, ITEM]),
  RUGGED_HELMET_228 ("Rugged Helmet", "228", Rarity.SECRET, [TRAINER, ITEM, POKEMON_TOOL]),
  URN_OF_VITALITY_229 ("Urn of Vitality", "229", Rarity.SECRET, [TRAINER, SINGLE_STRIKE, ITEM]),
  WELCOMING_LANTERN_230 ("Welcoming Lantern", "230", Rarity.SECRET, [TRAINER, SINGLE_STRIKE, ITEM]),
  WATER_ENERGY_231 ("Water Energy", "231", Rarity.SECRET, [ENERGY, BASIC_ENERGY]),
  PSYCHIC_ENERGY_232 ("Psychic Energy", "232", Rarity.SECRET, [ENERGY, BASIC_ENERGY]),
  FIGHTING_ENERGY_233 ("Fighting Energy", "233", Rarity.SECRET, [ENERGY, BASIC_ENERGY]);
            ...
            delayedA (priority: LAST) {
              before (KNOCKOUT, self) {
                if ((ef as Knockout).byDamageFromAttack && bg.currentTurn == self.owner.opposite && self.owner.pbg.deck) {
                  ...
                  self.owner.pbg.deck.select(min: 1, max: 2, "Search for up to 2 cards", {true},self.owner).moveTo(self.owner.pbg.hand, hidden: true)
