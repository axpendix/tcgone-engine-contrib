...
public enum PokemodBaseSet implements CardInfo {
	...
	CRUSHING_HAMMER_107 ("Crushing Hammer", 107, Rarity.SECRET, [TRAINER, G-SPEC]),
	DOWSING_MACHINE_108 ("Dowsing Machine", 108, Rarity.SECRET, [TRAINER, G-SPEC]),
	Elixir_109 ("Elixir", 109, Rarity.SECRET, [TRAINER, G-SPEC]),
	Hacker_110 ("Hacker", 110, Rarity.SECRET, [TRAINER, G-SPEC]),
