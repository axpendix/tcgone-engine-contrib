...
public enum DiamondPearlPromos implements LogicCardInfo {
  ...
  TORTERRA_LV_X_DP09 ("Torterra Lv.X", "9", Rarity.PROMO, [LVL_X, POKEMON, _GRASS_]),
  INFERNAPE_LV_X_DP10 ("Infernape Lv.X", "10", Rarity.PROMO, [LVL_X, POKEMON, _FIRE_]),
  EMPOLEON_LV_X_DP11 ("Empoleon Lv.X", "11", Rarity.PROMO, [LVL_X, POKEMON, _WATER_]),
  LUCARIO_LV_X_DP12 ("Lucario Lv.X", "12", Rarity.PROMO, [LVL_X, POKEMON, _FIGHTING_]),
  ...
  DIALGA_LV_X_DP17 ("Dialga Lv.X", "17", Rarity.PROMO, [LVL_X, POKEMON, _METAL_]),
  PALKIA_LV_X_DP18 ("Palkia Lv.X", "18", Rarity.PROMO, [LVL_X, POKEMON, _WATER_]),
  DARKRAI_LV_X_DP19 ("Darkrai Lv.X", "19", Rarity.PROMO, [LVL_X, POKEMON, _DARKNESS_]),
  ...
  MEWTWO_LV_X_DP28 ("Mewtwo Lv.X", "28", Rarity.PROMO, [LVL_X, POKEMON, _PSYCHIC_]),
  RHYPERIOR_LV_X_DP29 ("Rhyperior Lv.X", "29", Rarity.PROMO, [LVL_X, POKEMON, _FIGHTING_]),
  REGIGIGAS_LV_X_DP30 ("Regigigas Lv.X", "30", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_]),
  HEATRAN_LV_X_DP31 ("Heatran Lv.X", "31", Rarity.PROMO, [LVL_X, POKEMON, _FIRE_]),
  ...
  DIALGA_LV_X_DP37 ("Dialga Lv.X", "37", Rarity.PROMO, [LVL_X, POKEMON, _METAL_]),
  GIRATINA_LV_X_DP38 ("Giratina Lv.X", "38", Rarity.PROMO, [LVL_X, POKEMON, _PSYCHIC_]),
  SHAYMIN_LV_X_DP39 ("Shaymin Lv.X", "39", Rarity.PROMO, [LVL_X, POKEMON, _GRASS_]),
  ...
  CHARIZARD_G_LV_X_DP45 ("Charizard G Lv.X", "45", Rarity.PROMO, [LVL_X, POKEMON, _FIRE_]),
  GARCHOMP_C_LV_X_DP46 ("Garchomp C Lv.X", "46", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_]),
  RAYQUAZA_C_LV_X_DP47 ("Rayquaza C Lv.X", "47", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_]),
  ...
  ARCEUS_LV_X_DP53 ("Arceus Lv.X", "53", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_]),
  BEGINNING_DOOR_DP54 ("Beginning Door", "54", Rarity.PROMO, [TRAINER]),
  ULTIMATE_ZONE_DP55 ("Ultimate Zone", "55", Rarity.PROMO, [TRAINER]),
  ARCEUS_LV_X_DP56 ("Arceus Lv.X", "56", Rarity.PROMO, [LVL_X, POKEMON, _COLORLESS_]);
