...
public enum Arceus implements LogicCardInfo {
  ...
  ARCEUS_LV_X_94 ("Arceus Lv.X", "94", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ARCEUS_LV_X_95 ("Arceus Lv.X", "95", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ARCEUS_LV_X_96 ("Arceus Lv.X", "96", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ...
  ARCEUS_AR1 ("Arceus", "AR1", Rarity.HOLORARE, [BASIC, POKEMON, _DARKNESS_, UNLIMITED_COPIES]),
  ARCEUS_AR2 ("Arceus", "AR2", Rarity.HOLORARE, [BASIC, POKEMON, _GRASS_, UNLIMITED_COPIES]),
  ARCEUS_AR3 ("Arceus", "AR3", Rarity.HOLORARE, [BASIC, POKEMON, _FIRE_, UNLIMITED_COPIES]),
  ARCEUS_AR4 ("Arceus", "AR4", Rarity.HOLORARE, [BASIC, POKEMON, _WATER_, UNLIMITED_COPIES]),
  ARCEUS_AR5 ("Arceus", "AR5", Rarity.HOLORARE, [BASIC, POKEMON, _COLORLESS_, UNLIMITED_COPIES]),
  ARCEUS_AR6 ("Arceus", "AR6", Rarity.HOLORARE, [BASIC, POKEMON, _LIGHTNING_, UNLIMITED_COPIES]),
  ARCEUS_AR7 ("Arceus", "AR7", Rarity.HOLORARE, [BASIC, POKEMON, _PSYCHIC_, UNLIMITED_COPIES]),
  ARCEUS_AR8 ("Arceus", "AR8", Rarity.HOLORARE, [BASIC, POKEMON, _FIGHTING_, UNLIMITED_COPIES]),
  ARCEUS_AR9 ("Arceus", "AR9", Rarity.HOLORARE, [BASIC, POKEMON, _METAL_, UNLIMITED_COPIES]);
