...
import tcgwars.logic.impl.gen1.GymHeros;
...
public enum BestOfTheGame implements LogicCardInfo {
  ...
  ROCKETS_SNEASEL_5 ("Rocket's Sneasal", "5", Rarity.PROMO, [POKEMON, BASIC, _DARK_]),
  DARK_IVYSAUR_6 ("Dark Ivysaur", "6", Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, _GRASS_]),
  DARK_VENUSAUR_7  ("Dark Venusar", "7", Rarity.PROMO, [POKEMON, EVOLUTION, STAGE2, _GRASS_]),
  ...
  public tcgwars.logic.card.Collection getCollection() {
    return tcgwars.logic.card.Collection.BEST_OF_THE_GAME;
  }
  ...
  public Card getImplementation() {
    switch (this) {
      ...
      case HITMONCHAN_2:
       ...
       case DARK_IVYSAUR_6:
        return evolution (this, hp:HP050, type:GRASS, retreatCost:2) {
          weakness FIRE
        pokeBody "Vine Pull", {
          ...
          delayedA {
              after RETREAT, {
                if(ef.retreater == self){ (switchYourOpponentsBenchedWithActive())}}
          }
        }
          move "Fury Strikes ", {
            ...
            energyCost G, G
            onAttack {
              3.times{noWrDamage 10, opp.all.oppSelect("Choose a Pokémon to put a marker on")}
            }
          }
        }
       ...
       return copy (GymChallenge.ROCKETS_MEWTWO_14, this);
       case ROCKETS_HITMONCHAN_9:
       return copy (GymHeros.ROCKETS_HITMONCHAN_11, this);
