 ...
 */
public enum DragonMajesty implements LogicCardInfo {
  ...
  BLAINE_S_LAST_STAND_69("Blaine's Last Stand", 69, Rarity.ULTRARARE, [TRAINER,SUPPORTER]),
      ...
      case SWITCH_RAFT_62:
        return itemCard (this) {
          ...
          onPlay {
            ...
            sw my.active, my.bench.select("Select the new active"), TRAINER_CARD
            if (!switchedPCS.active)
              heal 30, switchedPCS, TRAINER_CARD
          }
          playRequirement{
