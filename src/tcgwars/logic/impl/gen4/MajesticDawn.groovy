      ...
      case KABUTOPS_6:
        return evolution (this, from:"Kabuto", hp:HP120, type:FIGHTING, retreatCost:2) {
          ...
          pokeBody "Primal Shell", {
            ...
            delayed {
              before PLAY_TRAINER, {
                if (self.active && ef.cardToPlay.cardTypes.is(ITEM) && bg.currentTurn == self.owner.opposite && (ef.cardToPlay as Card).player == self.owner.opposite) {
        ...
        return basic (this, hp:HP050, type:PSYCHIC, retreatCost:1) {
          ...
          pokePower "PUT", {
            ...
            actionA {
              ...
              powerUsed()
              directDamage 10, my.all.findAll{!it.name.contains("Unown")}.select("Put 1 damage counter on 1 of your Pokémon")
            }
          }
          move "Hidden Power", {
