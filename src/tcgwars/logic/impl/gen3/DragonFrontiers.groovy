...
public enum DragonFrontiers implements LogicCardInfo {
  ...
  VIBRAVA_DELTA_42 ("Vibrava", 42, Rarity.UNCOMMON, [POKEMON, EVOLUTION, STAGE, DELTA1, _PSYCHIC_]),
  ...
  ALTARIA_EX_DELTA_90 ("Altaria ex", 90, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE1, DELTA, _WATER_]),
  DRAGONITE_EX_DELTA_91 ("Dragonite ex", 91, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _GRASS_]),
  FLYGON_EX_DELTA_92 ("Flygon ex", 92, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _PSYCHIC_]),
  GARDEVOIR_EX_DELTA_93 ("Gardevoir ex", 93, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _FIRE_]),
  KINGDRA_EX_DELTA_94 ("Kingdra ex", 94, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _FIGHTING_]),
  LATIAS_EX_DELTA_95 ("Latias ex", 95, Rarity.ULTRARARE, [POKEMON, BASIC, DELTA, _FIRE_]),
  LATIOS_EX_DELTA_96 ("Latios ex", 96, Rarity.ULTRARARE, [POKEMON, BASIC, DELTA, _WATER_]),
  RAYQUAZA_EX_DELTA_97 ("Rayquaza ex", 97, Rarity.ULTRARARE, [POKEMON, BASIC, DELTA, _LIGHTNING_]),
  SALAMENCE_EX_DELTA_98 ("Salamence ex", 98, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _WATER_]),
  TYRANITAR_EX_DELTA_99 ("Tyranitar ex", 99, Rarity.ULTRARARE, [POKEMON, EVOLUTION, STAGE2, DELTA, _LIGHTNING_]),
