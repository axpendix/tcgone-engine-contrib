      ...
      case DITTO_17:
        return basic (this, hp:HP060, type:C, retreatCost:1) {
          ...
          move "Copy Anything", {
            ...
            energyCost C
            attackRequirement {
              assert opp.all.any{it.baseMoves} : "No moves to perform"
            }
            onAttack {
              def pcs = opp.all.findAll{it.baseMoves}.select("Which Pokémon will you copy an attack from? Choose carefully, this selection cannot be undone.")
              def move=choose(pcs.baseMoves+["End Turn (Skip)"], "Choose 1 of ${pcs}'s attacks. (Do not select a move if you don't have necessary energy or it will fail) ")
