...
public enum RisingRivals implements CardInfo {
	...
	ALAKAZAM_E4_LV_X_103 ("Alakazam E4 LV.X", 103, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _PSYCHIC_]),
	FLOATZEL_GL_LV_X_104 ("Floatzel GL LV.X", 104, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _WATER_]),
	FLYGON_LV_X_105 ("Flygon LV.X", 105, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _COLORLESS_]),
	GALLADE_E4_LV_X_106 ("Gallade E4 LV.X", 106, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _PSYCHIC_]),
	HIPPOWDON_LV_X_107 ("Hippowdon LV.X", 107, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _FIGHTING_]),
	INFERNAPE_E4_LV_X_108 ("Infernape E4 LV.X", 108, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _FIRE_]),
	LUXRAY_GL_LV_X_109 ("Luxray GL LV.X", 109, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _LIGHTNING_]),
	MISMAGIUS_GL_LV_X_110 ("Mismagius GL LV.X", 110, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _PSYCHIC_]),
	SNORLAX_LV_X_111 ("Snorlax LV.X", 111, Rarity.HOLORARE, [POKEMON_LVX, EVOLUTION, POKEMON, _COLORLESS_]),
