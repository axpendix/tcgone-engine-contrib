...
public enum SupremeVictors implements LogicCardInfo {
  ...
  ABSOL_G_LV_X_141 ("Absol G", "141", Rarity.HOLORARE, [LVL_X, POKEMON, _DARKNESS_]),
  BLAZIKEN_FB_LV_X_142 ("Blaziken FB", "142", Rarity.HOLORARE, [LVL_X, POKEMON, _FIRE_]),
  CHARIZARD_G_LV_X_143 ("Charizard G", "143", Rarity.HOLORARE, [LVL_X, POKEMON, _FIRE_]),
  ELECTIVIRE_FB_LV_X_144 ("Electivire FB", "144", Rarity.HOLORARE, [LVL_X, POKEMON, _LIGHTNING_]),
  GARCHOMP_C_LV_X_145 ("Garchomp C", "145", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_]),
  RAYQUAZA_C_LV_X_146 ("Rayquaza C", "146", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_]),
  STARAPTOR_FB_LV_X_147 ("Staraptor FB", "147", Rarity.HOLORARE, [LVL_X, POKEMON, _COLORLESS_]),
