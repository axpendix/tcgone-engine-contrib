...
public enum DiamondPearl implements LogicCardInfo {
  ...
  EMPOLEON_LV_X_120 ("Empoleon Lv.X", "120", Rarity.HOLORARE, [STAGE2, LVL_X, POKEMON, _WATER_]),
  INFERNAPE_LV_X_121 ("Infernape Lv.X", "121", Rarity.HOLORARE, [STAGE2, LVL_X, POKEMON, _FIRE_]),
  TORTERRA_LV_X_122 ("Torterra Lv.X", "122", Rarity.HOLORARE, [STAGE2, LVL_X, POKEMON, _GRASS_]),
