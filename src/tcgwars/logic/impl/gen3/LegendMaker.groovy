...
public enum LegendMaker implements LogicCardInfo {
  ...
  CLAW_FOSSIL_78 ("Claw Fossil", "78", Rarity.COMMON, [TRAINER, FOSSIL, ITEM]),
  MYSTERIOUS_FOSSIL_79 ("Mysterious Fossil", "79", Rarity.COMMON, [TRAINER, FOSSIL, ITEM]),
  ROOT_FOSSIL_80 ("Root Fossil", "80", Rarity.COMMON, [TRAINER, FOSSIL, ITEM]),
  ...
  REGICE_STAR_90 ("Regice Star", "90", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _WATER_]),
  REGIROCK_STAR_91 ("Regirock Star", "91", Rarity.HOLORARE, [POKEMON_STAR, POKEMON, BASIC, _FIGHTING_]),
    ...
    switch (this) {
      ...
      return evolution (this, from:"Gastly", hp:HP070, type:P, retreatCost:1) {
        ...
        move "Time Spiral", {
          ...
          energyCost C, C
          attackRequirement {
            assert opp.all.any{ it.evolution } : "Opponent has no evolved Pokémon"
          }
          onAttack {
