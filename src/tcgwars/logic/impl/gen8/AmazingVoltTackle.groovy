...
public enum AmazingVoltTackle implements LogicCardInfo {
  ...
  ORBEETLE_VMAX_9 ("Orbeetle VMAX", "9", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  ...
  GALARIAN_DARMANITAN_VMAX_24 ("Galarian Darmanitan VMAX", "24", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  ...
  PIKACHU_VMAX_31 ("Pikachu VMAX", "31", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _LIGHTNING_]),
  ...
  AEGISLASH_VMAX_81 ("Aegislash VMAX", "81", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _METAL_]),
  ...
  ORBEETLE_VMAX_112 ("Orbeetle VMAX", "112", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _GRASS_]),
  GALARIAN_DARMANITAN_VMAX_113 ("Galarian Darmanitan VMAX", "113", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _WATER_]),
  PIKACHU_VMAX_114 ("Pikachu VMAX", "114", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _LIGHTNING_]),
  AEGISLASH_VMAX_115 ("Aegislash VMAX", "115", Rarity.ULTRARARE, [POKEMON, EVOLUTION, POKEMON_V, VMAX, _METAL_]),
      ...
      return specialEnergy (this, [[]]) {
        ...
        onPlay {reason->
          eff = getter GET_WEAKNESSES, self, { holder ->
            if (self != null && self.types.contains(M)) {
              targeted self, SRC_SPENERGY, {
                holder.object.clear()
              }
            }
