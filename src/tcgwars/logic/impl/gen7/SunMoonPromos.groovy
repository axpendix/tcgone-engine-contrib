...
public enum SunMoonPromos implements LogicCardInfo {
  ...
  ZAPDOS_SM145 ("Zapdos", 145, Rarity.PROMO, [POKEMON, BASIC, _LIGHTNING_]),
  LEAFEON_GX_SM146 ("Leafeon-GX", 146, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _GRASS_]),
  GLACEON_GX_SM147 ("Glaceon-GX", 147, Rarity.PROMO, [POKEMON, BASIC, POKEMON_GX, _WATER_]),
  ...
  MELMETAL_GX_SM178 ("Melmetal-GX", 178, Rarity.PROMO, [POKEMON, EVOLUTION, STAGE1, POKEMON_GX, _METAL_]),
