...
public enum RisingRivals implements LogicCardInfo {
  ...
  TECHNICAL_MACHINE_G_95 ("Technical Machine G", "95", Rarity.UNCOMMON, [TRAINER, ITEM, TECHNICAL_MACHINE, TEAM_GALACTICS_INVENTION]),
  SP_RADAR_96 ("SP Radar", "96", Rarity.UNCOMMON, [TRAINER, ITEM, TEAM_GALACTICS_INVENTION]),
      ...
      case NIDOQUEEN_30:
        return evolution (this, from:"Nidorina", hp:HP120, type:PSYCHIC, retreatCost:3) {
          ...
          pokeBody "Maternal Comfort", {
            ...
            delayedA (priority: BEFORE_LAST2) {
              before BEGIN_TURN, {
                if (bg.em().retrieveObject("Maternal_Comfort" + self.owner) != ef.oldTurnCount) {
                  bc "$thisAbility activates"
